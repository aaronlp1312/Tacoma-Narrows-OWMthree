const weatherThemes = {
  "01d": {"background-gradient":"#4da8ff, #d9f1ff","accent-color":"#a1c4fd","border-color":"#bcd6ff","theme-description":"Clear light stretches across the Sound, sharpening every ridge and ripple.","theme-quote":"Calm, open-air weather with bright visibility and cool shade."},
  "01n": {"background-gradient":"#000814, #0c2f55","accent-color":"#2c3e50","border-color":"#587a9c","theme-description":"A quiet night settles over the water, stars flickering between the evergreens.","theme-quote":"Still and crisp, colder than it looks with excellent visibility."},

  "02d": {"background-gradient":"#ffcf71, #87cefa","accent-color":"#ffb347","border-color":"#ffd89b","theme-description":"Soft clouds drift slowly, letting sunlight spill across the hills in warm bursts.","theme-quote":"Bright with passing shade and a mild, steady breeze."},
  "02n": {"background-gradient":"#2c3e50, #4f7aa8","accent-color":"#1e3c72","border-color":"#6f8fb4","theme-description":"Moonlight slips between scattered clouds, silvering the edges of the skyline.","theme-quote":"Gentle and cool with shifting moonlight and light winds."},

  "03d": {"background-gradient":"#cfd3d6, #f7f7f7","accent-color":"#95a5a6","border-color":"#cfd7d9","theme-description":"Gray layers drift overhead, softening the distance and quieting the landscape.","theme-quote":"Muted daylight with cooler air and steady cloud cover."},
  "03n": {"background-gradient":"#2f3b45, #2c363d","accent-color":"#34495e","border-color":"#708392","theme-description":"Clouds settle low over the city, dimming the night into a calm hush.","theme-quote":"Cozy and still with stable temperatures and low wind."},

  "04d": {"background-gradient":"#9aa0a6, #6e7377","accent-color":"#7f8c8d","border-color":"#b2bcc0","theme-description":"A thick gray sky stretches from ridge to ridge, softening every shadow.","theme-quote":"Brooding but steady with cooler air and diffused light."},
  "04n": {"background-gradient":"#3a3a3a, #2c3237","accent-color":"#2c3e50","border-color":"#6f7f8d","theme-description":"Low clouds mute the night, turning the Sound into a quiet silhouette.","theme-quote":"Still and heavy with warmer air and low visibility."},

  "09d": {"background-gradient":"#6c8ea0, #2f5d73","accent-color":"#4b79a1","border-color":"#93b4c8","theme-description":"Light rain drifts across the water, softening the edges of the world.","theme-quote":"Gentle showers with damp roads and mild wind."},
  "09n": {"background-gradient":"#3b4652, #2a3d4c","accent-color":"#5d6d7e","border-color":"#8298a8","theme-description":"Rain taps softly on rooftops, glowing under scattered streetlights.","theme-quote":"Soothing drizzle with slick surfaces and quiet air."},

  "10d": {"background-gradient":"#2f8f83, #1b4f72","accent-color":"#43cea2","border-color":"#6fd1b8","theme-description":"Steady rain washes the Sound in silver, blurring the hills into watercolor.","theme-quote":"Persistent rainfall with reduced visibility and cooler temps."},
  "10n": {"background-gradient":"#0a2a43, #1a3f59","accent-color":"#2b5876","border-color":"#6f8fa9","theme-description":"A cool rain settles over the night, softening the glow of the city.","theme-quote":"Calm but damp with slick roads and steady showers."},

  "11d": {"background-gradient":"#1e3c72, #2a5298","accent-color":"#3a6073","border-color":"#6f8ec7","theme-description":"Thunder rolls across the Sound, shaking the stillness with sudden energy.","theme-quote":"Electric and unstable with gusts, lightning, and rapid changes."},
  "11n": {"background-gradient":"#000000, #1b335c","accent-color":"#1a1a1a","border-color":"#5c6f8f","theme-description":"Lightning flickers behind low clouds, painting the night in brief flashes.","theme-quote":"Charged atmosphere with sudden wind and thunder."},

  "13d": {"background-gradient":"#dff6ff, #bde0fe","accent-color":"#e0eafc","border-color":"#d4ecff","theme-description":"Snow drifts quietly across the landscape, softening every sound and shape.","theme-quote":"Cold and bright with slippery surfaces and reduced traction."},
  "13n": {"background-gradient":"#8fae8f, #6d8079","accent-color":"#a2ab58","border-color":"#a7c0a9","theme-description":"Snowfall glows under streetlights, turning the night into a quiet lantern.","theme-quote":"Hushed and icy with freezing patches and low visibility."},

  "50d": {"background-gradient":"#c8c8c8, #9e9e9e","accent-color":"#decba4","border-color":"#e0d2b4","theme-description":"Fog drifts through the lowlands, softening the world into muted shapes.","theme-quote":"Misty and cool with limited visibility and slower travel."},
  "50n": {"background-gradient":"#5a5a5a, #3c4247","accent-color":"#434343","border-color":"#7f8c95","theme-description":"Dense fog turns the night into a soft blur of light and shadow.","theme-quote":"Dreamlike but risky with very low visibility."}
};  
